...
RECOVERY_FSTAB := $(TARGET_RECOVERY_OUT)/root/first_stage_ramdisk/fstab.$(TARGET_PRODUCT)
VENDOR_FSTAB := $(TARGET_OUT_VENDOR)/etc/fstab.$(TARGET_PRODUCT)
INITRAMFS_FSTAB := $(TARGET_RAMDISK_OUT)/fstab.$(TARGET_PRODUCT)
...
LOCAL_PREBUILT_MODULE_FILE := $(VENDOR_FSTAB) $(RECOVERY_FSTAB) $(INITRAMFS_FSTAB)
